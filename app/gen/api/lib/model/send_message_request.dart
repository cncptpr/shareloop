...
class SendMessageRequest {
  ...
  @override
  String toString() => 'SendMessageRequest[content=$content]';
  ...
  static SendMessageRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'content'), 'Required key "SendMessageRequest[content]" is missing from JSON.');
        assert(json[r'content'] != null, 'Required key "SendMessageRequest[content]" has a null value in JSON.');
        return true;
      }());
