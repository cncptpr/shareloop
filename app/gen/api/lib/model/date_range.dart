...
class DateRange {
  ...
  static DateRange? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'startDate'), 'Required key "DateRange[startDate]" is missing from JSON.');
        assert(json[r'startDate'] != null, 'Required key "DateRange[startDate]" has a null value in JSON.');
        assert(json.containsKey(r'endDate'), 'Required key "DateRange[endDate]" is missing from JSON.');
        assert(json[r'endDate'] != null, 'Required key "DateRange[endDate]" has a null value in JSON.');
        return true;
      }());
